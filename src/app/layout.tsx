...
export const metadata: Metadata = {
  ...
  title: 'Ph - Mai Eldobily — Smart Pharmacy App',
  description:
    'Ph - Mai Eldobily is your trusted smart pharmacy app in Abu Kabir. Search medicines, get smart suggestions, and order with confidence — available 24/7.',
  icons: {
    icon: [{ url: '/favicon.ico', type: 'image/x-icon' }],
  },
  openGraph: {
    title: 'Ph - Mai Eldobily — Smart Pharmacy',
    description: 'Trusted pharmacy app in Abu Kabir. Search medicines, 24/7 support.',
